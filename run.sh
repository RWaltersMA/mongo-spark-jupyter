...
docker-compose exec mongo1 wget https://github.com/RWaltersMA/mongo-spark-jupyter/raw/master/data.csv
docker-compose exec mongo1 /usr/bin/mongoimport --host=rs0/mongo1:27017,mongo2:27018,mongo3:27019 -d=CDCData -c=obesity --type=csv --file=data.csv --drop --headerline 
